...
public class DemandeAdapter extends RecyclerView.Adapter<MyViewHolder7> {
    ...
    public DemandeAdapter(Context context, List<Demande> list_demande) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder7 holder, int position) {
        ...
        holder.accepter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                demandeRef.child(key).child("statusDemande").setValue(1);
            }
        });
