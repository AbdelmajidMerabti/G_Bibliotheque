...
public class DemandeStatus1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demande_status1);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DemandeStatus1.this,ListDemandeActivity.class));
            }
        });
        // searchView.clearFocus();
        GridLayoutManager gridLayoutManager = new GridLayoutManager(DemandeStatus1.this,1);
        recyclerView.setLayoutManager(gridLayoutManager);
        AlertDialog.Builder bulider = new AlertDialog.Builder(DemandeStatus1.this);
        ...
        // list_livre.clear();
        demandeAdapter = new DemandeAdapter(DemandeStatus1.this,list_demande);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot item : snapshot.getChildren())
                {
                    ...
                    if(dataDemande!=null) {
                        ...
                        if(dataDemande.getStatusDemande() == 0) {
